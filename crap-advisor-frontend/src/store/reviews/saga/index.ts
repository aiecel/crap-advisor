...
import { StrictEffect, all, call, put, select, take, takeLatest } from 'redux-saga/effects';
...
function* getReviewsByIdSaga(action: PayloadAction<string>): Generator<StrictEffect, void> {
  try {
...
export function* watchGetReviewsByIdSaga(): SagaIterator {
