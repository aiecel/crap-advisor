...
const Sidebar = (): JSX.Element => {
    const {result: reviews, currentRestroom} = useAppSelector(state => state.REVIEWS);
            ...
            {currentRestroom && (
                <>
                    <section className="section-restroom">
                        <p className="restroom-created">{new Date(currentRestroom.created).toLocaleDateString()}</p>
                        <p className="restroom-name">{currentRestroom.name}</p>
                        {currentRestroom.rating && <p className="restroom-rating">{currentRestroom.rating}</p>}
